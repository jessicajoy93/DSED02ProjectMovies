...
namespace DSED02ProjectMovies
{
    public partial class Form1 : Form
    {
        ...
        #region DGV Content Changed - Customer, Movie
        ...
        private void btnAddMovie_Click(object sender, EventArgs e)
        {
            ...
            if ((txtMovieYear.Text != string.Empty) && (txtMovieCopies.Text != string.Empty) && (txtMovieGenre.Text != string.Empty) && (txtMovieName.Text != string.Empty) && (txtMoviePlot.Text != string.Empty) && (txtMovieRating.Text != string.Empty))
            {
                try
                {
                    myDatabase.Result = myDatabase.InsertOrUpdateMovie(txtMovieRating.Text, txtMovieName.Text, txtMovieYear.Text, txtMovieCopies.Text, txtMoviePlot.Text, txtMovieGenre.Text, lblMovieID.Text, "Add");
        ...
        private void btnUpdateMovie_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                myDatabase.Result = myDatabase.InsertOrUpdateMovie(txtMovieRating.Text, txtMovieName.Text, txtMovieYear.Text, txtMovieCopies.Text, txtMoviePlot.Text, txtMovieGenre.Text, lblMovieID.Text, "Update");
